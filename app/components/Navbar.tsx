      ...
      <div className="max-w-7xl mx-auto px-4 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-2">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-full whitespace-nowrap bg-green-500 text-white hover:bg-green-600 transition-all"
          >
            <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a
            href="#contact"
            className="inline-flex items-center justify-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-full whitespace-nowrap bg-gradient-to-r from-amber-600 to-orange-500 text-white hover:opacity-90 transition-all shadow-md"
          >
        ...
        <div className="lg:hidden bg-white border-t border-amber-100 shadow-xl">
          <div className="px-4 py-4 flex flex-col gap-1">
            ...
            <div className="flex gap-2 pt-3 mt-2 border-t border-amber-100">
              <a
                href="tel:+916260552014"
                className="flex-1 text-center bg-amber-50 border border-amber-200 text-amber-700 font-semibold py-1.5 rounded-full text-xs"
              >
                {nav.call || "📞 Call"}
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 text-center bg-green-500 text-white font-semibold py-1.5 rounded-full text-xs"
              >
                {nav.whatsapp || "💬 WhatsApp"}
              </a>
              <a
                href="#contact"
                onClick={() => setMenuOpen(false)}
                className="flex-1 text-center bg-gradient-to-r from-amber-600 to-orange-500 text-white font-semibold py-1.5 rounded-full text-xs"
              >
                {nav.bookNow || "Book Puja"}
              </a>
            </div>
