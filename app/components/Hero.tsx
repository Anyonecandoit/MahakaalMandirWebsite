        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-32 pt-36">
          ...
          >
            ...
            >
              <a
                  href="#contact"
                  className="bg-gradient-to-r from-amber-500 to-orange-500 text-white font-bold px-6 py-3.5 rounded-xl shadow-lg"
              >
                📅 Book Puja Now
              </a>
              ...
              <a
                  href="tel:+916260552014"
                  className="bg-white/10 border border-white/30 text-white px-5 py-3.5 rounded-xl hover:bg-white/20"
              >
                📞 Call Now
              </a>
              ...
              <a
                  href="https://wa.me/916260552014"
                  target="_blank"
                  className="bg-green-500 text-white px-5 py-3.5 rounded-xl hover:bg-green-600"
              >
                💬 WhatsApp Booking
              </a>
            </motion.div>
