export default function WhatsAppButton() {
  return (
    <a
      href="https://wa.me/918085039147?text=Namaste! I want to book a puja at Mangalnath Temple, Ujjain."
      target="_blank"
      rel="noopener noreferrer"
      className="fixed bottom-6 right-6 z-50 bg-green-500 text-white w-14 h-14 rounded-full shadow-2xl shadow-green-900/40 hover:scale-110 hover:bg-green-600 transition-all flex items-center justify-center"
